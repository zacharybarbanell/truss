...
public class Truss
{
    ...
    public static final RegistryObject<Block> WOOD_TRUSS = 
        BLOCKS.register("wood_truss", () -> new Block(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Item> WOOD_TRUSS_ITEM = 
        ITEMS.register("wood_truss", () -> new BlockItem(WOOD_TRUSS.get(), new Item.Properties()));
